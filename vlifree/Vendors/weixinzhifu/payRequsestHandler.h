...
#define APP_ID          @"wxaac5e5f7421e84ac"               //APPID
#define APP_SECRET      @"055e7e10c698b7b140511d8d1a73cec4" //appsecret
//商户号，填写商户对应参数
#define MCH_ID          @"1245069702"
//商户API密钥，填写相应参数
#define PARTNER_ID      @"I57gmdk90nd5bla84nkyqldicn3294Fh"
//支付结果回调页面
